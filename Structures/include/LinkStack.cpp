...
class LinkStack : public base::stack<T, base::basic_node> {
  ...
  public:
    virtual LinkStack& push(value_t const& val) override;
    virtual LinkStack& push(value_t&& val) override;

    virtual LinkStack& pop( ) override;
    virtual value_t&& pop_get( ) override;

    virtual LinkStack& copy( ) const override;
    virtual void clear( ) override;

    virtual LinkStack& operator= (LinkStack const& other) override;
    virtual LinkStack& operator= (LinkStack&& other) override;
